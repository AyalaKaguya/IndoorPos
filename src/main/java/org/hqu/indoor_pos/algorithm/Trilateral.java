...
public class Trilateral implements Dealer {
	...
	public Location getLocation(String str) {
		...
		calculate(uniqueBases, terminalId);

		// System.err.println("location.getxAxis() = " + location.getxAxis());
		// System.err.println("location.getyAxis() = " + location.getyAxis());
		// System.err.println("location.getRoomId() = " + location.getRoomId());
		// System.err.println("location.getEmpId() = " + location.getEmpId());
		// System.err.println("location.getTimeStamp() = " + location.getTimeStamp());
	...
	public Location calculate(List<BleBase> bases, String terminalId) {
		...
		// System.err.println("baseNum = " + baseNum);
